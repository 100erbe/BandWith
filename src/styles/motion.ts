...
export const springs = {
  smooth: { type: "tween" as const, duration: 0.3, ease: "easeOut" },
  snappy: { type: "tween" as const, duration: 0.2, ease: "easeOut" },
  bouncy: { type: "tween" as const, duration: 0.25, ease: [0.34, 1.56, 0.64, 1] },
  card: { type: "tween" as const, duration: 0.3, ease: "easeOut" },
  menu: { type: "tween" as const, duration: 0.25, ease: "easeOut" },
  dashboard: { type: "tween" as const, duration: 0.25, ease: "easeOut" },
} as const;
...
export const cardTransition = { type: "tween" as const, duration: 0.3, ease: "easeOut" };
...
export const menuItemVariants = {
  ...
  show: { y: 0, opacity: 1, transition: { type: "tween" as const, duration: 0.2, ease: "easeOut" } },
  exit: { y: 15, opacity: 0, transition: { type: "tween" as const, duration: 0.15, ease: "easeIn" } }
};
...
export const dashboardContainerVariants = {
  ...
  show: {
    opacity: 1, 
    y: 0,
    transition: { duration: 0.25, ease: "easeInOut" as const, staggerChildren: 0.06 }
  },
  exit: {
    opacity: 0, 
    y: -15,
    transition: { duration: 0.2, ease: "easeInOut" as const, staggerChildren: 0.03, staggerDirection: -1 }
  }
};

export const dashboardItemVariants: any = {
