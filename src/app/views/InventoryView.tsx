      ...
      <div className="px-4 py-3">
        <div className="relative">
          <input
            ...
            className="w-full px-4 py-2.5 pl-10 rounded-xl bg-black/5 text-sm font-medium placeholder:text-black/30 focus:outline-none focus:ring-2 focus:ring-black/10"
          />
      ...
      <div className="flex-1 overflow-y-auto px-4 py-3 space-y-2">
        {loading ? (
          ...
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-sm font-bold text-black/40">No items found</p>
            <p className="text-xs text-black/30 mt-1">Add equipment to get started</p>
          </div>
        ) : (
          filteredItems.map((item) => (
            ...
            >
              <div className="w-10 h-10 rounded-lg bg-black/5 flex items-center justify-center shrink-0">
                <Package className="w-5 h-5 text-black/40" />
              </div>
              <div className="flex-1 min-w-0">
                <p className="text-sm font-bold text-black truncate">{item.name}</p>
                <p className="text-xs font-medium text-black/40">{item.category} · Qty: {item.quantity}</p>
              </div>
              <div className={cn(
